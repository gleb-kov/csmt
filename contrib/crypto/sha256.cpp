...
const unsigned int SHA256_impl::sha256_k[64] = //UL = uint32
...
void SHA256_impl::transform(const unsigned char *message, unsigned int block_nb) {
    uint32 w[64];
    uint32 wv[8];
    uint32 t1, t2;
...
void SHA256_impl::update(const unsigned char *message, unsigned int len) {
